function [normalizedPower,outputFrequency] = normalizedPower(wantedEpochSignals,baselineSignals,functionType,takeMean)
...
%         [pxx,f] = periodogram(oneWindowBaseline,[],[0:10:500],1000);
%         w = f;
